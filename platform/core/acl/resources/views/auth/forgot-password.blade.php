...
@section('content')
    ...
    <p><a class="lost-pass-link" href="{{ route('access.password.create') }}" title="Create Account">Do you have a seller account?</a></p>
    {!! Form::close() !!}
@stop
@push('footer')
    <script>
        ...
        email.addEventListener('focusout', function() {
            document.getElementFById('emailGroup').classList.remove('focused');
        });
